...
public enum ItemLocationEnum {
    ...
    // Things to put around the neck, such as necklaces, broaches, scarfs, neck ribbons.  Can have at the same time with Head items ex. Ribbon for Hair, and Ribbon for Neck is OK to have
    Necklace(12),
