...
public class ItemViewModel {
    ...
    static {
        // Adding Sample Items
        addItem(new ItemModel("Power Shield", "Powerful Shield", 1, 1, 7,ItemLocationEnum.OffHand, AttributeEnum.Defense, "power_shield"));
        addItem(new ItemModel("Blue Lightsaber", "Powerful Jedi Weapon", 8, 8, 9,ItemLocationEnum.PrimaryHand, AttributeEnum.Attack, "lightsaber"));
        addItem(new ItemModel("Thermal Detonator", "Great Blast Radius", 9, 8, 6,ItemLocationEnum.Finger, AttributeEnum.Attack,"thermal_detonator"));
